...
<head>
    ...
    <title>Educa - School, College, University And Courses HTML5 Template</title>
                        ...
                        <div class="header-top-contact">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="header-top-contact-info">
                                        <a href="/cdn-cgi/l/email-protection#6d04030b022d08150c001d0108430e0200"><span
                                                class="__cf_email__"
                                                data-cfemail="99f0f7fff6d9fce1f8f4e9f5fcb7faf6f4">[email&#160;protected]</span></a>
                                    </div>
                                </li>
                                <li>
                                    <div class="header-top-contact-icon">
                    ...
                    <div class="collapse navbar-collapse" id="main_nav">
                        ...
                        <div class="nav-right">
                            ...
                            <div class="nav-right-btn mt-2">
                                <a href="login.html" class="theme-btn"><span class="fal fa-pencil"></span>Login </a>
                                <!-- </div>
<div class="nav-right-btn mt-2">
<a href="application-form.html" class="theme-btn"><span class="fal fa-pencil"></span>Apply Now</a>
</div> -->
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-5 ms-lg-auto">
                            <div class="cta-content">
                                ...
                                <div class="cta-btn">
                                    <a href="login.html" class="theme-btn">Login<i
                                            class="fas fa-arrow-right-long"></i></a>
                                </div>
                                <!-- <div class="cta-btn">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="footer-widget-box about-us">
                            ...
                            <ul class="footer-contact">
                                ...
                                <li><a href="/cdn-cgi/l/email-protection#b3daddd5dcf3d6cbd2dec3dfd69dd0dcde"><i
                                            class="far fa-envelope"></i><span class="__cf_email__"
                                            data-cfemail="f39a9d959cb3968b929e839f96dd909c9e">[email&#160;protected]</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 align-self-center">
                            <p class="copyright-text">
                                &copy; Copyright <span id="date"></span> <a href="#"> Educa </a> All Rights Reserved.
                            </p>
                        </div>
                        <div class="col-md-6 align-self-center">
